...
module register_file #(
   parameter Dbits = 32,                      // Number of memory locations
   parameter Nloc = 32,                      // Number of bits in data
   parameter initfile = "imem_screentest.mem"       // Name of file with initial values
)(
